  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      <div>
        ...
        <p className="text-sm text-gray-500 dark:text-slate-400 mt-1">Export your data to a JSON file or clear all your records.</p>
      </div>

      <div className="flex gap-4">
        <button
          onClick={async () => {
            if (window.confirm('Are you sure you want to fix the corrupted analytics? This will reset all DSA solves after July 7th to 0.')) {
              try {
                ...
                alert('Corrupted analytics fixed! Rows updated: ' + (data?.length || 0));
              } catch (e) {
        ...
        >
          Fix Corrupted Heatmap Spike
        </button>
      </div>

      <div className="pt-4 border-t border-[var(--border)]"></div>
